...
namespace Stock.DataAccess
{
    public class StockDbContext : DbContext
    {
        ...
        {
            Database.SetInitializer(new StockDbContextInitializer());
        }

        public DbSet<Vender> Venders { get; set; }
        public DbSet<Item> Items { get; set; }

        class StockDbContextInitializer : CreateDatabaseIfNotExists<StockDbContext>
        {
            protected override void Seed(StockDbContext context)
            {
                ...
                IList<Vender> defaultVenders = new List<Vender>
                {
                ...
                context.Venders.AddRange(defaultVenders);
